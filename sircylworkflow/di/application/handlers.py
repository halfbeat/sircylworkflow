...
from sircylworkflow.di.domain.commands import GenerarPlanDescargaCommand, Handler
from sircylworkflow.di.domain.model import FormatoDescarga
from sircylworkflow.di.domain.security import MyUsuario, Permisos
from sircylworkflow.di.view.model import AsientoViewDto, PlanDescargaViewDto


class GenerarPlanDescargaHandler(Handler):
